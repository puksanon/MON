<template>
    <div class="card text-center">
        ...
        <div class="card-body">
            ...
            <button type="button" class="btn btn-select" data-toggle="modal" data-target="#Select3">
            SELECT
            </button>
        </div>
        <div class="modal fade" id="Select3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-body">
                    <div class="card-deck">
                        <div class="card pointer" v-for="(item , index) in footer"  
                            v-bind:item="item"
                            v-bind:index="index"
                            v-bind:key="item.id"
